...
--
-- Host: localhost    Database: themevio
-- ------------------------------------------------------
...
CREATE TABLE `follow_user` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `follow_user_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
...
CREATE TABLE `posts` (
  ...
  `primary_font` varchar(40) DEFAULT NULL,
  `secondary_font` varchar(40) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2021-01-22 16:35:08
